...
function recSubdivisionMidPointWithColor( v1, v2, v3, 
								 c1, c2, c3,
								 coordsArray,
								 colorsArray,
								 recursionDepth ) {
	...
	if( recursionDepth == 0 ) {
        ...
        recSubdivisionMidPointWithColor( v1, mid12, mid31, c1, c12, c31,
                                coordsArray, colorsArray, recursionDepth - 1 );

        recSubdivisionMidPointWithColor( v2, mid23, mid12, c2, c23, c12,
                                coordsArray, colorsArray, recursionDepth - 1 );

        recSubdivisionMidPointWithColor( v3, mid31, mid23, c3, c31, c23,
                                coordsArray, colorsArray, recursionDepth - 1 );

        recSubdivisionMidPointWithColor( mid12, mid23, mid31, c12, c23, c31,
                                coordsArray, colorsArray, recursionDepth - 1 );
	}
}
...
function midPointRefinementWithColor( coordsArray, 
						     colorsArray, 
							 recursionDepth ) {
    ...
    for( origIndex = 0; origIndex < origArrayLength; origIndex += 9 )
    {
        ...
        recSubdivisionMidPointWithColor( origCoords.slice( origIndex, origIndex + 3 ),
								origCoords.slice( origIndex + 3, origIndex + 6 ),
								origCoords.slice( origIndex + 6, origIndex + 9 ),
...
function recSubdivisionCentroidWithColor( v1, v2, v3, 
								 c1, c2, c3,
								 coordsArray,
								 colorsArray,
								 recursionDepth ) {
	...
	if( recursionDepth == 0 ) {
		...
		var centroidPoint = computeCentroid(v1, v2, v3)
        ...
        recSubdivisionMidPointWithColor( v1, v2, centroidPoint, c1, c2, centroidColor,
                                coordsArray, colorsArray, recursionDepth - 1 );

        recSubdivisionMidPointWithColor( v2, v3, centroidPoint, c2, c3, centroidColor,
                                coordsArray, colorsArray, recursionDepth - 1 );

        recSubdivisionMidPointWithColor( v3, v1, centroidPoint, c3, c1, centroidColor,
                                coordsArray, colorsArray, recursionDepth - 1 );
	}
}
...
function centroidRefinementWithColor( coordsArray, 
						     colorsArray, 
							 recursionDepth ) {
	...
	for( origIndex = 0; origIndex < origArrayLength; origIndex += 9 )
    {
        ...
        recSubdivisionCentroidWithColor( origCoords.slice( origIndex, origIndex + 3 ),
								origCoords.slice( origIndex + 3, origIndex + 6 ),
								origCoords.slice( origIndex + 6, origIndex + 9 ),
								origColors.slice( origIndex, origIndex + 3 ),
								origColors.slice( origIndex + 3, origIndex + 6 ),
